...
public class ItemController {
    ...
    @PostMapping
    public ResponseEntity<Object> createItem(@RequestBody @Validated(Create.class) CreateItemRequest itemDto,
    ...
    @PatchMapping("/{itemId}")
    public ResponseEntity<Object> editItem(@RequestBody @Validated(Update.class) CreateItemRequest itemDto,
                                           @RequestHeader("X-Sharer-User-Id") Integer userId,
